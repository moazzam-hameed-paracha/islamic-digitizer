...
export default function ExportPanel({ job, onExportAll, onReset }: ExportPanelProps) {
  ...
  return (
    <div className={styles.panel}>
      {/* Stats */}
      <div className={styles.statsGrid} dir="rtl">
        <div className={styles.statCard}>
          <span className={styles.statVal}>{donePages.length}</span>
          <span className={styles.statKey}>صفحة مكتملة</span>
        </div>
        <div className={styles.statCard}>
          <span className={styles.statVal}>{totalLines.toLocaleString("ar")}</span>
          <span className={styles.statKey}>سطر مستخرج</span>
        </div>
        <div className={styles.statCard}>
          <span className={styles.statVal}>{totalChars.toLocaleString("ar")}</span>
          <span className={styles.statKey}>حرف عربي</span>
        </div>
      </div>

      {/* Actions */}
      <div className={styles.actions} dir="rtl">
